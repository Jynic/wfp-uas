    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav" class="nav-content collapse {{request()->segment(1) == 'provinsi' ? 'show' : ''}} {{request()->segment(1) == 'kota' ? 'show' : ''}} {{request()->segment(1) == 'dinas' ? 'show' : ''}} {{request()->segment(1) == 'jenisfasum' ? 'show' : ''}} {{request()->segment(1) == 'fasum' ? 'show' : ''}} {{request()->segment(1) == 'staff' ? 'show' : ''}} {{request()->segment(1) == 'user' ? 'show' : ''}}" data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="{{ route('jenisfasum') }}" class="{{request()->segment(1) == 'jenisfasum' ? 'active' : ''}}">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse {{request()->segment(1) == 'pelaporan' ? 'show' : ''}} {{request()->segment(1) == 'pelaporanadmin' ? 'show' : ''}}" data-bs-parent="#sidebar-nav">
                <li>
        ...
        <li class="nav-item">
            <a class="nav-link {{request()->segment(1) == 'historypelaporan' ? '' : 'collapsed'}}" data-bs-target="#report-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-journal-text"></i><span>Report</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="report-nav" class="nav-content collapse {{request()->segment(1) == 'historypelaporan' ? 'show' : ''}}" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('historypelaporan') }}" class="{{request()->segment(1) == 'historypelaporan' ? 'active' : ''}}">
                        <i class="bi bi-circle"></i><span>History Perbaikkan</span>
                    </a>
                </li>
            </ul>
        </li>
