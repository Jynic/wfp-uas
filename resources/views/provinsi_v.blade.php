...
<body>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body p-3">
              <table id="tableProvinsi" class="table table-striped wrapped" style="width:100%">
                <thead>
                  <tr>
                    <th>Kode</th>
                    <th>Nama</th>
                  ...
                  <form action="#" id="form">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukan Kode Provinsi">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-12 mb-3">
                        <label for="nama" class="form-label">Nama Provinsi</label>
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Provinsi">
                      </div>
                    </div>
                  </form>
                </div>
  ...
  <script>
    ...
    function save(id) {
      if (id == 0) {
        var url = "{{ route('provinsi.simpan') }}";
      } else {
        var url = "{{ route('provinsi.update') }}";
      }
      $.ajax({
        type: 'POST',
        url: url,
