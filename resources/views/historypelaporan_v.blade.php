...
<body>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      initFlatPic();
      generateSTCode();
      initializeSelect2('select[name=\'pic_fasum[]\']', "{{ route('historypelaporan.getDataStaff') }}", 'Pilih Staff');
      initializeSelect2('select[name=\'fasum[]\']', "{{ route('historypelaporan.getDataFasum') }}", 'Pilih Fasum');
      let map;
      let marker;
      var i = 10;
