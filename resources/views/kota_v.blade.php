...
<body>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body p-3">
              <table id="tableKota" class="table table-striped wrapped" style="width:100%">
                <thead>
                  <tr>
                    <th>Nama</th>
                    <th>Provinsi</th>
                  ...
                  <form action="#" id="form">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukan Kode Kota / Kabupaten">
                      </div>
                      <div class="form-group col-md-6 mb-3">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Kota / Kabupaten">
                      </div>
                      <div class="form-group col-md-6 mb-3">
                        <label for="jenis_kota_kabupaten" class="form-label">Jenis Data</label>
                        <select name="jenis_kota_kabupaten" id="jenis_kota_kabupaten" class="form-control">
  ...
  <script>
    ...
    $(document).ready(function() {
      getData();
      initializeSelect2('#provinsi', "{{ route('kota.getDataProvinsi') }}", 'Pilih Provinsi');

      var customButton = $('<button/>', {
        text: 'Tambah Kota', // Button text
        id: 'myCustomButton', // Button ID
        class: 'btn btn-primary', // Additional classes for styling if needed
        click: function() {
          tambah_kota(); // Call the function directly here
        }
      });
    ...
    function save(id) {
      if (id == 0) {
        var url = "{{ route('kota.simpan') }}";
      } else {
        var url = "{{ route('kota.update') }}";
      }
      $.ajax({
        type: 'POST',
        url: url,
    ...
    function edit(id) {
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#id').val(data[0].idkota_kabupaten);
          $('#kode').val(data[0].kode);
          $('#nama').val(data[0].nama);
          var option = new Option(data[0].provinsi_nama, data[0].provinsi_id, true, true);
          $('#provinsi').append(option).trigger('change');
          $("#jenis_kota_kabupaten").val(data[0].jenis);
          $('#modal_form').modal('show');
          $('#btnSave').text('Update');
