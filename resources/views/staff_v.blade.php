...
<body>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body p-3">
              <table id="tableStaff" class="table table-striped wrapped" style="width:100%" enctype="multipart/form-data">
                <thead>
                  <tr>
                    <th>Nama</th>
                    <th>Dinas</th>
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
              <div class="modal-content overflow">
                <div class="modal-header">
                  <h5 class="modal-title" id="modal-title">Form Input Staff</h5>
                  ...
                  <form id="form">
                    ...
                    <div class="row mb-3">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Staff" required>
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <select name="jabatan" class="form-control" id="jabatan" style="width: 100%">
                        </select>
                      </div>
                    </div>
                    <div class="row mb-3">
  ...
  <script>
    ...
    $(document).ready(function() {
      getData();
      initializeSelect2('#dinas', "{{ route('staff.getDataDinas') }}", 'Pilih Dinas');
