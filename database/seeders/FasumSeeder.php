...
class FasumSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('m_fasum')->insert([
            ...
            ['idfasum' => 4, 'm_dinas_iddinas' => 4, 'nama' => 'Rumah Sakit Lorem ipsum', 'luas_fasum' => 2000, 'kondisi_fasum' => 'Baik', 'asal_fasum' => 'APBN', 'lat' => '-7.3150508016307905', 'lng' => '112.76729822158815', 'gambar' => '-', 'status_aktif' => 1],
